...
const OneM: array[1..10] of String = ('', 'iaei ', 'aaa ', 'o?e ', '	aou?a
', 'iyou ', 'oanou ', 'naiu ', 'ainaiu ', 'aaayou ');
      OneF: array[1..10] of String = ('', 'iaia ', 'aaa ', 'o?e ', '	aou?a
', 'iyou ', 'oanou ', 'naiu ', 'ainaiu ', 'aaayou ');
      Tens: array[1..10] of String = ('', 'aanyou ','aaaaoaou ','o?eaoaou
','ni?ie ','iyouaanyo ', 'oanouaanyo ','naiuaanyo ','ainaiuaanyo
','aaayiinoi ');
      Ten2: array[1..10] of String = ('','iaeiiaaoaou ','aaaiaaoaou
','o?eiaaoaou ','	aou?iaaoaou ','iyoiaaoaou ','oanoiaaoaou ','naiiaaoaou
','ainaiiaaoaou ','aaayoiaaoaou ');
      Huns: array[1..10] of String = ('','noi ','aaanoe ','o?enoa
','	aou?anoa ','iyounio ','oanounio ','naiunio ','ainaiunio ','aaayounio ');

      Names: array[1..6,1..3] of String = ((' eiiaeea',' eiiaeee','
eiiaae'),
                                    ('?oaeu ','?oaey ','?oaeae '),
                                    ('ouny	a ','ouny	e ','ouny	 '),
...
function DigToStr(var buff : char; dig : double; level : integer; var ISO :
char):char;
...
function DigToStr(var buff : string; dig : double ; level : integer ; var
ISO : char):string;
var
  tmpstr  : string[100] ;
  tmpstr2 : string[100] ;
